...
CAFE = {
    "name": "24 Roots",
    "tagline": "Coffee • Craft • Cultivate — Hyderabad's underground slow bar.",
    "description": (
        ...
        "Specialty coffee, slow-bar pours, brunch plates and house desserts — "
        "brewing rituals served in earthy, plant-filled calm."
    ),
    "story": (
...
CATEGORIES = [
    ...
    ("specialty-coffee", "Specialty Coffee", "Small-batch classics pulled on our house blend.", 2),
    ("brunch", "Brunch", "All-day brunch plates, from truffle toast to baos.", 3),
    ("desserts", "Desserts", "House-made sweet finishes, freshly baked.", 4),
]
...
ITEMS = [
    ...
    # ----- Espresso Bar -----
    ("24r-signature-latte", "specialty-coffee", "24 Roots Signature Latte", "Double shot, silky steamed milk, house cacao dust.", 260, 1, 1, "1561047029-3000c68339ca"),
    ("24r-cortado", "specialty-coffee", "Cortado", "Equal parts espresso and warm milk, served in glass.", 220, 1, 0, "1461023058943-07fcbe16d735"),
    ("24r-flat-white", "specialty-coffee", "Flat White", "Ristretto shots under velvet micro-foam.", 240, 1, 0, "1534778101976-62847782c213"),
    ("24r-v60-pour", "specialty-coffee", "V60 Pour-Over", "Single-origin, brewed to order. Ask for today's roast.", 290, 1, 1, "1544787219-7f47ccb76574"),
    ("24r-cappuccino", "specialty-coffee", "Cappuccino", "Classic ratio, cocoa-dusted, extra smooth.", 230, 1, 0, "1572442388796-11668a67e53d"),
    ("24r-hot-chocolate", "specialty-coffee", "Thick Hot Chocolate", "Belgian couverture melted into steamed milk.", 250, 1, 0, "1542990253-a781e04c0082"),
    ("24r-filter-kaapi", "specialty-coffee", "South-Indian Filter Kaapi", "Chicory blend, frothed in a dabara-tumbler.", 180, 1, 1, "1511920170033-f8396924c348"),
    # ----- Brunch -----
    ("24r-truffle-mushroom-toast", "brunch", "Truffle Mushroom Toast", "Sourdough, wild mushrooms, truffle oil, parmesan snow.", 380, 1, 1, "1603505090741-9ddcf5d0c318"),
    ("24r-chilli-cheese-toast", "brunch", "Chilli Cheese Toast", "Three cheeses, roasted chillies, toasted sourdough.", 320, 1, 0, "1504753793650-d4a2b783c15e"),
    ("24r-peri-peri-fries", "brunch", "Peri-Peri Shoestring Fries", "Double-fried, house peri-peri dust, garlic aioli.", 240, 1, 1, "1573080496219-bb080dd4f877"),
    ("24r-mushroom-galouti", "brunch", "Mushroom Galouti Sliders", "Two mini buns, galouti-spiced mushroom patties, mint aioli.", 420, 1, 0, "1553979459-2229ca95b805"),
    ("24r-chicken-bao", "brunch", "Steamy Chicken Baos", "Fluffy baos, soy-garlic glaze, pickled cucumber.", 380, 0, 1, "1496116218417-1a781b1c416c"),
    ("24r Alfredo-pasta", "brunch", "Truffle Alfredo Pasta", "Slow-reduced cream, parmesan, cracked pepper, herbs.", 460, 1, 0, "1621996346565-e3dbc646d9a9"),
    ("24r-buddha-bowl", "brunch", "Harvest Buddha Bowl", "Quinoa, roasted pumpkin, hummus, tahini drizzle.", 420, 1, 0, "1512621776951-a57141f2eefd"),
    ("24r-nachos", "brunch", "Loaded Nachos", "Cheese sauce, salsa fresca, jalapeños, sour cream.", 360, 1, 0, "1513456852971-30c0b8199d4d"),
    # ----- Desserts -----
